...
function createCash() {
  ...
  var cash = createSprite(Math.round(random(50, 100),40, 10, 10));
...
function createDiamonds() {
  ...
  var diamonds = createSprite(Math.round(random(110, 200),40, 10, 10));
  diamonds.addImage(diamondsImg);
  diamonds.scale=0.03;
  diamonds.velocityY = 3;
  diamonds.lifetime = 610;
...
function createjewelry() {
  ...
  var jewelry = createSprite(Math.round(random(210, 350),40, 10, 10));
  jewelry.addImage(jewelryImg);
  jewelry.scale=0.13;
  jewelry.velocityY = 3;
  jewelry.lifetime = 610;
